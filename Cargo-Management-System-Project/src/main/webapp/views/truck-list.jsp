...
<div class="container">
    ...
    <table class="table">
        ...
        <tbody>
        <c:forEach var="truckItem" items="${truckList}">
            <tr>
                <td>${truckItem.name}</td>
                <td>${truckItem.description}</td>
                <td>${truckItem.weight}</td>
                <td>${truckItem.volume}</td>
                <td>${truckItem.pickupDate}</td>
                <td>${truckItem.deliveryDate}</td>
                <td>
                    <a href="/truck-edit?truckId=${truckItem.truckId}" class="btn btn-primary">Edit</a>
                    <a href="/truck-delete?truckId=${truckItem.truckId}" class="btn btn-danger">Delete</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
