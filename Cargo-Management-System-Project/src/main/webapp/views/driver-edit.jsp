...
<div class="container mt-5">
    <h1>Driver Edit Page</h1>

    <!-- Create/Update Driver Form -->
    <form method="get" action="/updateDriver">
        <input type="hidden" name="driverId" value="${driverDto.driverId}">
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control" id="pickupDate" name="pickupDate" pattern="yyyy-MM-dd HH:mm:ss" value="${driverDto.pickupDate}">
        </div>
        <div class="form-group">
            <label for="deliveryDate">Delivery Date</label>
            <input type="date" class="form-control" id="deliveryDate" name="deliveryDate" pattern="yyyy-MM-dd HH:mm:ss" value="${driverDto.deliveryDate}">
        </div>
