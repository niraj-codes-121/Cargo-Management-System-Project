...
<div class="container mt-5">
    ...
    <form method="post" action="/createTruck">
        <input type="hidden" name="truckId" value="${truckDto.id}">
        ...
        <div class="form-group">
            <label for="manufactureDate">Pickup Date</label>
            <input type="date" class="form-control" id="pickupDate" name="pickupDate" value="${truckDto.pickupDate}">
        </div>
        
         <div class="form-group">
            <label for="deliveryDate">Delivery Date</label>
            <input type="date" class="form-control" id="deliveryDate" name="deliveryDate" value="${truckDto.deliveryDate}">
        </div>
